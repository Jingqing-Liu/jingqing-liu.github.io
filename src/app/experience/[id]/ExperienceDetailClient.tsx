      ...
      <div className="container mx-auto px-6 md:px-8 pt-24 pb-16">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <h1 className="text-[1.625rem] md:text-[2.625rem] font-bold text-[#1c1c1e] tracking-tight mb-2">{localize(lang, exp.title, exp.title_zh)}</h1>
            <p className="text-base text-[#007aff] font-medium">{localize(lang, exp.company, exp.company_zh)}</p>
            {exp.supervisor && (
