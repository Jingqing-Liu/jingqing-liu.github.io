...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'hero.proof.label': 'Previously:',
    'hero.proof.items': 'WeChat API vulnerability analysis · Roblox platform security research · Bitcoin protocol verification',
  ...
  zh: {
    ...
    'hero.proof.label': '研究经历：',
    'hero.proof.items': '微信 API 漏洞分析 · Roblox 平台安全研究 · 比特币协议验证',
