  ...
  return <div className={s.page} lang="zh-CN"><div className={s.shell}>
    ...
    <div className={s.layout}>
      ...
      <div className={s.content} ref={contentRef} tabIndex={-1}>
        ...
        <div className={s.roomBreadcrumb}><button onClick={showOverview}><LayoutGrid size={13} />空间总览</button><span aria-hidden="true">/</span><span title={project.title}>{project.title}</span></div>
